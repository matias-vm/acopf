...
param Vinit {i in buses}; #initial point (flat-start hardcoded in python script)
param thetadiffinit {i in branches}; #initial point (flat-start hardcoded in python script)
